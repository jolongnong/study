      ...
      <tr > 
       ...
       <tr>
          <td colspan="3" bgcolor="<%=title_c%>"   align="center">
            ...
            <input type="button"  value="게시판" onclick="javascript:window.location='/free/views/board/list.jsp'">
          </td></form></tr></table>
       ...
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="<%=value_c%>" align="center">
             ...
             <input type="button"  value="게시판" onclick="javascript:window.location='/free/views/board/list.jsp?id=<%=id%>'">
             </form>
         </td>
        </tr>
       <tr > 
